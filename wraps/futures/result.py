...
class FutureResult(Future[Result[T, E]]):
    """[`Future[Result[T, E]]`][wraps.futures.base.Future], adapted to leverage future functionality."""
    ...
    async def actual_unwrap_or(self, default: T) -> T:  # type: ignore[misc]
    ...
    async def actual_unwrap_error_or(self, default: E) -> E:  # type: ignore[misc]
