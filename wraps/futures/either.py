...
class FutureEither(Future[Either[L, R]]):
    """[`Future[Either[L, R]]`][wraps.futures.base.Future], adapted to leverage future functionality."""
    ...
    async def actual_left_or(self, default: L) -> L:  # type: ignore[misc]
    ...
    async def actual_right_or(self, default: R) -> R:  # type: ignore[misc]
